...
## Saving folder path
image_folder_path = "images_dense"
...
def plot_all(all_data, method_info, log_scale=False, show=False):
    ...
    if log_scale:
        plt.xscale('log')
        plt.yscale('log')
        plt.savefig(os.path.join(image_folder_path, "dense_all_loglog.pdf"))

    else:
        plt.savefig(os.path.join(image_folder_path, "dense_all.pdf"))
...
def plot_BaseFW(method_data, method_name, method_color, method_marker, log_scale=False):
    ...
    plt.savefig(os.path.join(image_folder_path, "dense_BFW.pdf"))
...
def plot_FW(method_data, method_name, method_color, method_marker, log_scale=False):
    ...
    plt.savefig(os.path.join(image_folder_path, "dense_FW.pdf"))
...
def plot_dij(method_data, method_name, method_color, method_marker, log_scale=False):
    ...
    plt.savefig(os.path.join(image_folder_path, "dense_DIJ.pdf"))
...
def plot_Pdij(method_data, method_name, method_color, method_marker, log_scale=False):
    ...
    plt.savefig(os.path.join(image_folder_path, "dense_PDIJ.pdf"))
...
def plot_BlockedFW(method_data, method_name, method_color, method_marker, log_scale=False):
    ...
    plt.savefig(os.path.join(image_folder_path, "dense_BlockedFW.pdf"))
...
def plot_PFW(method_data, method_name, method_color, method_marker, log_scale=False):
    ...
    plt.savefig(os.path.join(image_folder_path, "dense_PFW.pdf"))
